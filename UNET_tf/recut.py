...
print(inputs)
# inputs.tofile("../data/inputs.dat", sep="\n", format="%s")
# # print(inputs)
# gamma = []
# beta = []
# for i in range(8):
...
# biases = np.array(gamma + beta)
# biases.tofile("../data/biases.dat", sep="\n", format="%s")
...
# print(-0.227789+1.2097951)
print(intermediate_output)
# print(w[1])
# intermediate_output.tofile("D:/Winter2021/Research/FlexCNN/SDx_project/FlexCNN_opt/data/L2_outputs.dat", sep="\n", format="%s")
# print(inputs)
# print(-0.974544 -0.042008743)
# print(-0.0010054803)
# print(-0.974544)
# print(intermediate_output)
