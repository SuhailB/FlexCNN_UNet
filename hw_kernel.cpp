...
// #define DEBUG_weight
    ...
    uint bias_offset = BIAS_OFFSET;//MODIFY
    ...
    ap_uint<4> FILTER = (LAYER_CONV_TYPE == 2)? (ap_uint<4>)(KH_KW>>28) : (ap_uint<4>)FILTER_S2;
        ...
        #pragma HLS pipeline
      	...
      	if (norm_conv_en){
            ...
            printf("\n");
      #endif
      			memcpy((void*)beta_conv_burst_buf, (void*)&global_bias[0], sizeof(data_t2) * LAYER_OUT_NUM_T);
      		}
            ...
            printf("\n");
      #endif
      			memcpy((void*)gamma_conv_burst_buf, (void*)&global_bias[1], sizeof(data_t2) * LAYER_OUT_NUM_T);
      		}
      	}
    }
