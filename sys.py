...
SA_COLS = 8
SA_ROWS = 8
in_num_hw, out_num_hw, in_h_hw, in_w_hw, out_h_hw, out_w_hw                     = 8, 32, 256, 256, 256, 256
in_num, out_num, in_h, in_w, out_h, out_w                                       = 3, 32, 256, 256, 256, 256
cin_offset, weight_offse, bias_offset, cout_offset, filter_s1, filter_s, stride = 0, 0, 0, 1195088, 1, 1, 1
INST, prev_cin_offset, in_num_t, out_num_t, in_h_t, in_w_t, nxt_layer_batch     = 4, 0, 8, 32, 8, 64, 1
